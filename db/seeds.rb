...
# we create seed_users, seed_categories and seed_posts methods to
# create User, Category and Post records inside the development database.
# Also the faker gem is used to generate dummy text. see the seed_post method

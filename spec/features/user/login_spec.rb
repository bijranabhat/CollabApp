...
RSpec.feature "Login", :type => :feature do
    ...
    # Then we fill the form and submit it. 
    # Finally, we check if we have the #user-settings element on the navigation bar,
    # which is available only for signed in users.
